...
public class PacketCreator {
     ...
     */
    public static PacketAddCharacter createPacketAddCharacter(String name, int id, float x, float y, boolean tagged) {
    ...
    public static PacketScoreId createPacketScoreId(int id, float score) {
        PacketScoreId packetScoreId = new PacketScoreId();
        packetScoreId.setId(id);
        packetScoreId.setScore(score);
        return packetScoreId;
    }
